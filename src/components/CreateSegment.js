...
export const CreateSegment = (props) => {
    ...
    const createSegment = async () => {
        try {
            ...
            if (response.data && response.data.customers) {
                ...
                //api call for segment creation
                const segmentResponse = await axios.post(`${URL}/api/createSegment`, segmentData);
    ...
    const sendMessage = async () => {
        ...
        try {
            const response = await axios.post(`${URL}/api/sendCampaign`, {
                segmentId,
                messageTemplate
            });
